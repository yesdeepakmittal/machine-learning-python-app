...
```python
#Even after having a splitted dataset, we're splitting training into three datasets
```
...
#x_train=60% of features,x_test=40%,y_train=60% of labls,y_test=40% of labels
